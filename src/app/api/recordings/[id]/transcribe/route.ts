...
export async function POST(
    ...
    try {
        ...
        // A transcription already exists and the caller didn't ask to
        // overwrite. Don't error out: return the existing transcription so a
        // client whose snapshot went stale (e.g. it was generated by a
        // background auto-transcribe after the page rendered) displays it
        // instead of getting stuck on "No transcription available". Overwriting
        // only happens when force is set, which never reaches this branch.
